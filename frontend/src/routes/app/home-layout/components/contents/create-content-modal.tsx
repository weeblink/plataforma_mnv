...
import { Dialog, DialogContent, DialogHeader, DialogTrigger, DialogDescription, DialogTitle, DialogFooter } from "@/components/ui/dialog";
...
const formSchema = z.object({
    type: z.enum(['course', 'mentoring', 'extra']),
})
...
export default function CreateContentModal({
    ...
    async function onSubmit( values: z.infer<typeof formSchema> ){
        ...
        try {
            ...
            await api.post(`/home-layout-content/store`, {
                home_layout_id: parentHomeId,
                type: values.type,
