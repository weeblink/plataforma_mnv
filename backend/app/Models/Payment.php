...
class Payment extends Model
{
     ...
     * @throws Exception
     */
    private function getInstanceApp(CredentialsCheckout $credentials): Appmax
    {
        $instances = [
            'appmax'    => Appmax::class
        ];

        $className = $instances[$credentials->app_name] ?? null;
     ...
     * @throws Exception
     */
    public function changeStatusPayment($data, string $app_name): void
    {
        $credentials = CredentialsCheckout::where('app_name', $app_name)->first();
