...
use App\Http\Controllers\HomeLayoutContentController;
...
Route::middleware('api')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::group(['middleware' => 'abilities:is-admin'], function () {
            ...
            Route::prefix('home-layout')->group(function(){
                Route::controller(HomeLayoutController::class)->group(function() {
                    Route::get('/list', 'index');
                    Route::post('/store', 'store');
                    Route::get('/show/{id}', 'show');
                    Route::post('/update/{id}', 'update');
                    Route::delete('/destroy/{id}', 'destroy');
                    Route::patch('/swap-order', 'swap');
                });
            });

            Route::prefix('home-layout-content')->group(function(){
                Route::controller(HomeLayoutContentController::class)->group(function() {
                    Route::post('/store', 'store');
                    Route::post('/update/{id}', 'update');
                    Route::delete('/destroy/{id}', 'destroy');
                    Route::patch('/swap-order', 'swap');
    ...
    Route::prefix('webhook/payments/')
        ...
        ->group(function () {
            Route::controller(PaymentController::class)->group(function () {
                Route::post("/{app_name}", 'updateStatusPayment')->name('webhook.updateStatusPayment');
            });
        });
